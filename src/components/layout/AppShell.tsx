...
function AppFrame({ children }: Readonly<{ children: ReactNode }>) {
  ...
  return (
    <div className="min-h-screen text-aviation-white">
      ...
      >
        <header className="sticky top-0 z-30 border-b border-white/10 bg-aviation-ink/82 backdrop-blur-xl">
          <div className="flex min-h-16 items-center gap-3 px-4 sm:px-6 lg:px-8">
            <button
              type="button"
              className="focus-ring inline-flex h-10 w-10 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-100 lg:hidden"
            ...
            <button
              type="button"
              className="focus-ring hidden h-10 w-10 items-center justify-center rounded-md border border-white/10 bg-white/5 text-slate-100 lg:inline-flex"
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs uppercase tracking-[0.18em] text-aviation-cyan/80">Flight Academy Simulator</p>
              <h1 className="truncate text-base font-semibold text-white sm:text-lg">{currentPage?.label ?? "Academia"}</h1>
            </div>

            <div className="hidden min-w-64 items-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm text-slate-400 md:flex">
